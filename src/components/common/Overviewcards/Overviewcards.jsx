...
export const Overviewcards = ({ cardTitle, cardValue, percent, icon }) => {
  return (
    <div className="border border-[#D4D4D4] rounded-md p-4 shadow bg-[var(--primary-color)] flex justify-center items-center gap-3">
      <div className="flex-1 flex flex-col gap-2">
        <p className="font-[var(paraFont)] text-[1dvw] text-[var(--paraText-color)] font-medium">
          {cardTitle}
        </p>
        <h2 className="text-[1.6dvw] font-semibold leading-[normal]">
          {cardValue}
        </h2>
