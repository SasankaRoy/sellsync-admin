    ...
    <div className="fixed top-0 left-0 w-screen h-screen bg-black/50 backdrop-blur-lg z-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-md shadow p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="w-full bg-[var(--sideMenu-color)] flex justify-between items-center px-3 py-1.5 text-white rounded-md mb-4">
          <h3 className="font-semibold text-lg sm:text-xl lg:text-[1.8dvw]">Product Details</h3>
          <button 
            onClick={onClose}
        ...
        <div className="p-6">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-2/3 space-y-6">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6">{product.name}</h2>
                <div className="flex items-center gap-2 mb-8">
                  <span className={`px-4 py-1.5 rounded-full text-sm font-medium ${getStatusColor(product.stock)}`}>
                    {product.status}
                  </span>
                </div>
              </div>
...
const InventorySeller = () => {
  ...
  const items = [
    ...
    { 
      ...
      status: "Current Stock", 
      image: "productImg1",
      description: "High-quality Arabica coffee beans for a rich and smooth coffee experience."
    },
    { 
      id: 4,
      name: "Almonds", 
    ...
    { 
      ...
      status: "In Stock", 
      image: "productImg1",
      description: "Pure and natural organic honey for a healthier alternative to refined sugars."
    },
    { 
      id: 6,
      ...
      status: "In Stock", 
      image: "productImg1",
      description: "Rich and decadent dark chocolate bar with a smooth and velvety texture."
    },
    { 
      id: 7,
    ...
    { 
      ...
      status: "Out of Stock", 
      image: "productImg1",
      description: "Creamy and rich coconut milk for soups, curries, and desserts."
    },
    { 
      id: 9,
    ...
    <Layout>
      <div className="w-full">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          ...
          {/* Items Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pt-4 border-t border-gray-100">
              ...
              filteredItems.map((item) => (
                ...
                >
                  ...
                  <button 
                    ...
                    className="mt-3 w-full bg-gray-600 hover:bg-gray-700 text-white font-[500] mainFont py-2 px-4 rounded-full flex items-center justify-center space-x-2 transition-colors shadow-sm text-sm"
                  >
