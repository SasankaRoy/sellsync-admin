        ...
        <div className="flex-1 pb-8 sm:pb-12 md:pb-14 lg:pb-16">
          ...
          <div className="flex flex-col justify-center items-center gap-2 w-full min-h-[20vh] sm:min-h-[22vh] md:min-h-[22vh] lg:min-h-[25dvh] overflow-hidden my-4 sm:my-6 md:my-5">
            <div className="flex justify-between items-center w-full p-2 sm:p-3 md:p-2.5">
              <h3 className="text-lg sm:text-xl md:text-xl lg:text-[1.3dvw] font-[600]">Sales Stats</h3>
            </div>
          ...
          <div className="flex flex-col justify-center items-center gap-2 w-full min-h-[20vh] sm:min-h-[22vh] md:min-h-[22vh] lg:min-h-[25dvh] overflow-hidden my-4 sm:my-6 md:my-5">
            <div className="flex justify-between items-center w-full p-2 sm:p-3 md:p-2.5">
              <h3 className="text-lg sm:text-xl md:text-xl lg:text-[1.3dvw] font-[600]">Inventory Stats</h3>
            </div>
            <div className="w-full h-full flex flex-col lg:flex-row justify-center gap-3 sm:gap-4 md:gap-3">
              {/* Inventory Data List */}
              <div className="flex-1 shrink-0 flex flex-col gap-2 sm:gap-3 md:gap-2.5 justify-center items-start rounded-md bg-[var(--primary-color)] py-4 sm:py-6 md:py-5 px-2">
          ...
          <div className="w-full my-4 sm:my-6 md:my-5 rounded-lg overflow-hidden border border-[#D4D4D4] bg-white">
            <div className="bg-[var(--button-color2)] text-white flex justify-center">
              <div className="flex-1 p-2 sm:p-3 md:p-2.5 flex justify-start items-center">
                <p className="text-sm sm:text-base md:text-base">Product Name</p>
              </div>
              <div className="min-w-[25%] sm:min-w-[20.5%] md:min-w-[22%] p-2 sm:p-3 md:p-2.5 flex justify-center items-center border-r border-l border-[#D4D4D4]">
                <p className="text-sm sm:text-base md:text-base">Quantity</p>
              </div>
              <div className="min-w-[20%] sm:min-w-[20.5%] md:min-w-[22%] p-2 sm:p-3 md:p-2.5 flex justify-center items-center">
                <p className="text-sm sm:text-base md:text-base">Value</p>
              </div>
            </div>
            ...
            {[1, 2, 3, 4, 5].map((cur, id) => (
              ...
              >
                <div className="flex-1 p-2 sm:p-3 md:p-2.5 flex justify-start items-center">
                  <p className="text-xs sm:text-sm md:text-sm lg:text-[1.05dvw] line-clamp-2 text-[#7F7F7F] font-[var(--paraFont)]">
                    Budwiser Magnum 750ML
                  </p>
                </div>
                <div className="min-w-[25%] sm:min-w-[25%] md:min-w-[22%] flex justify-center items-center border-r border-l border-[#D4D4D4] p-2 sm:p-3 md:p-2.5">
                  <p className="font-semibold text-[#7F7F7F] font-[var(--paraFont)] text-sm sm:text-base md:text-base lg:text-[1.2dvw]">
                    12
                  </p>
                </div>
                <div className="min-w-[20%] sm:min-w-[20.5%] md:min-w-[22%] flex justify-center items-center p-2 sm:p-3 md:p-2.5">
                  <p className="font-semibold text-[#7F7F7F] font-[var(--paraFont)] text-sm sm:text-base md:text-base lg:text-[1.2dvw]">
                    $52
                  </p>
                </div>
